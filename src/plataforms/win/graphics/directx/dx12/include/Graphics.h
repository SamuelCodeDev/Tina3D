...
namespace Tina
{
	...
	inline void Graphics::Allocate(const uint32 sizeInBytes, ID3DBlob ** resource) const noexcept
	{ D3DCreateBlob(sizeInBytes, resource); }

	inline void Graphics::Copy(const void* vertices, const uint32 sizeInBytes, ID3DBlob * bufferCPU) const noexcept
